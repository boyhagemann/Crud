		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="{{ URL::action('Boyhagemann\Crud\ManagerController@manage', $key) }}">{{ $class->getName() }}</a></li>
					@endforeach
				</ul>
				@else
	...
	<div class="col-6">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<a href="{{ URL::action('Boyhagemann\Crud\ManagerController@scan') }}" class="btn btn-info">Scan for controllers</a>
			</div>
		</div>
